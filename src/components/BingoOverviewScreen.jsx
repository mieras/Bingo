...
const BingoOverviewScreen = ({ onNavigateToMail, onPlayNow, onStartGame, onSkipToResult }) => {
    ...
    <div className="bg-white overflow-clip relative rounded-tl-[12px] rounded-tr-[12px] size-full flex flex-col">
      <div className="flex flex-col flex-1 overflow-y-auto">
        ...
        <ContentWrapper className="flex flex-col px-4 pt-6 pb-8">
          ...
          {/* Datum Selector */}
          <div className="bg-white rounded-lg p-4 border border-gray-200 mb-6 flex items-center gap-3">
            ...
            <div className="relative px-4 pb-6">
              ...
              <div className="space-y-3 mb-4">
                <div className="flex items-start gap-2">
                  ...
                  <p className="text-white text-sm">Elke zondag staat de Bingo klaar</p>
                </div>
                <div className="flex items-start gap-2">
                  <div className="w-5 h-5 shrink-0 mt-0.5">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <p className="text-white text-sm">De eerste Bingo is maar liefst € 25.000,- waard!</p>
                </div>
              </div>
